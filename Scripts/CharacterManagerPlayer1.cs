...
public class CharacterManagerPlayer1 : MonoBehaviour
{
    ...
    {
        Character character = characterDB.GetCharacter(selectedOptionPlayer1);
        PlayerPrefs.SetString("player1Animator", character.animatorController.name);
        Save();
        SceneManager.LoadScene("Player2 Character Selection");
    }
}
