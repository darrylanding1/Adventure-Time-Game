...
public class Player1Movement : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (animator == null)
        {
            Debug.LogError("Animator component not found on Player 1.");
        }
    }
    ...
    private void FixedUpdate()
    {
        ...
        Debug.Log($"Player1 is grounded: {isGrounded}");
    }

    private void Update()
    {
        // Player 1 movement with WASD keys
